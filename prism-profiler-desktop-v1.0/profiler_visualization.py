...
def plot_mean_spectrum(df, selected_classes, class_colors):
...
def plot_individual_spectra(data, class_colors, selected_indices):
...
def plot_heatmap(df, title, caption=None):
